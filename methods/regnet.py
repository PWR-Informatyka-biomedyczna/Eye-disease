...
from torchvision.models import regnet_y_3_2gf, regnet_x_3_2gf, regnet_x_8gf, regnet_x_16gf, regnet_x_32gf
...
class RegNetX16gf(BaseModel):

    def __init__(self, num_classes: int):
        super(RegNetX16gf, self).__init__(num_classes)
        self._feature_extractor = regnet_x_16gf(True)
        net_fc = self._feature_extractor.fc.in_features
        self._feature_extractor.fc = nn.Linear(net_fc, self.num_classes, bias=True)
        self.input_size = (224, 224)
...
class RegNetX32gf(BaseModel):

    def __init__(self, num_classes: int):
        super(RegNetX32gf, self).__init__(num_classes)
        self._feature_extractor = regnet_x_32gf(True)
        net_fc = self._feature_extractor.fc.in_features
        self._feature_extractor.fc = nn.Linear(net_fc, self.num_classes, bias=True)
        self.input_size = (224, 224)
