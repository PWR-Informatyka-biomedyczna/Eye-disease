...
def pyramidnet50_a360(**kwargs):
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    return get_pyramidnet(blocks=50, alpha=360, model_name="pyramidnet50_a360", **kwargs)
...
class PyramidNet50(BaseModel):

    def __init__(self, num_classes: int):
        super(PyramidNet50, self).__init__(num_classes)
        self._feature_extractor = pyramidnet50_a360(pretrained=False, num_classes=num_classes)
...
class PyramidNet101(BaseModel):

    def __init__(self, num_classes: int):
        super(PyramidNet101, self).__init__(num_classes)
        self._feature_extractor = pyramidnet101_a360(pretrained=True, num_classes=num_classes)
        self.input_size = (224, 224)
